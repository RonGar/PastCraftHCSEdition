...
public class RendererBlockFence_2 extends jhhk
{
    private static ModelFence_2 model;
    private static final ResourceLocation model_texture;
    
    public RendererBlockFence_2() {
        RendererBlockFence_2.model = new ModelFence_2();
    }
    ...
    public void renderTileEntity(final TileEntityBlockFence_2 tileEntityBlockFence_2, final double n, final double n2, final double n3, final float n4) {
        ...
        this.func_110628_a(RendererBlockFence_2.model_texture);
        RendererBlockFence_2.model.render(0.0625f);
        GL11.glPopMatrix();
    }

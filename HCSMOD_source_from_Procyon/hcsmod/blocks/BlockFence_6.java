...
public class BlockFence_6 extends samw
{
    public BlockFence_6(final int n) {
        super(n, ccfp._d);
    }
    
    public void func_71902_a(final dxti dxti, final int n, final int n2, final int n3) {
        this.func_71905_a(0.0625f, 0.0f, 0.1875f, 0.9375f, 1.6f, 0.8125f);
    }
    
    public int func_71857_b() {
        return HCSBlocks.renderFence_6ID;
    }
    ...
    public void onBlockPlacedBy(final cuqu cuqu, final int n, final int n2, final int n3, final EntityLiving entityLiving, final ieta ieta) {
        cuqu.func_72921_c(n, n2, n3, dwbg._c(entityLiving.field_70177_z * 4.0f / 360.0f + 2.5) & 0x3, 3);
    }
    
    public ogpr func_72274_a(final cuqu cuqu) {
        return new TileEntityBlockFence_6();
    }

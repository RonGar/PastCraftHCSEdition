...
public class BlockFence_4 extends samw
{
    public BlockFence_4(final int n) {
        super(n, ccfp._d);
    }
    
    public void func_71902_a(final dxti dxti, final int n, final int n2, final int n3) {
        this.func_71905_a(0.0625f, 0.0f, 0.1875f, 0.9375f, 0.05f, 0.8125f);
    }
    
    public int func_71857_b() {
        return HCSBlocks.renderFence_4ID;
    }
    ...
    public ogpr func_72274_a(final cuqu cuqu) {
        return new TileEntityBlockFence_4();
    }

...
public class ModelFence_6 extends ModelBase
{
    ...
    public ModelFence_6() {
        ...
        (this.Shape4 = new ModelRenderer((ModelBase)this, 0, 27)).func_78789_a(0.0f, 0.0f, 0.0f, 16, 1, 1);
        this.Shape4.func_78793_a(-8.0f, 11.0f, 0.5f);
        this.Shape4.func_78787_b(64, 64);
        this.Shape4.field_78809_i = true;
        this.setRotation(this.Shape4, 0.0f, 0.0f, 0.0f);
        (this.Shape5 = new ModelRenderer((ModelBase)this, 4, 27)).func_78789_a(0.0f, 0.0f, 0.0f, 16, 1, 1);
        this.Shape5.func_78793_a(-8.0f, 20.0f, 0.5f);
        this.Shape5.func_78787_b(64, 64);
        this.Shape5.field_78809_i = true;
        this.setRotation(this.Shape5, 0.0f, 0.0f, 0.0f);
        (this.Shape6 = new ModelRenderer((ModelBase)this, 0, 27)).func_78789_a(0.0f, 0.0f, 0.0f, 16, 1, 1);
        this.Shape6.func_78793_a(-8.0f, 3.0f, 0.5f);
        this.Shape6.func_78787_b(64, 64);
        this.Shape6.field_78809_i = true;
        this.setRotation(this.Shape6, 0.0f, 0.0f, 0.0f);
        (this.Shape7 = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, 0.0f, 0.0f, 2, 24, 1);
        this.Shape7.func_78793_a(-4.0f, 0.0f, 0.0f);
        this.Shape7.func_78787_b(64, 64);
        this.Shape7.field_78809_i = true;
        this.setRotation(this.Shape7, 0.0f, 0.0f, 0.0f);
        (this.Shape8 = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, 0.0f, 0.0f, 2, 24, 1);

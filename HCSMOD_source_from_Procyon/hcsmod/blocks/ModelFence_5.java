...
public class ModelFence_5 extends ModelBase
{
    ...
    public ModelFence_5() {
        ...
        this.Shape1.func_78793_a(5.0f, 0.0f, 0.0f);
        this.Shape1.func_78787_b(64, 64);
        this.Shape1.field_78809_i = true;
        this.setRotation(this.Shape1, 0.0f, 0.0f, 0.0f);
        (this.Shape2 = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, 0.0f, 0.0f, 2, 24, 1);
        this.Shape2.func_78793_a(2.0f, 0.0f, 0.0f);
        this.Shape2.func_78787_b(64, 64);
        this.Shape2.field_78809_i = true;
        this.setRotation(this.Shape2, 0.0f, 0.0f, 0.0f);
        (this.Shape3 = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, 0.0f, 0.0f, 2, 24, 1);
        this.Shape3.func_78793_a(-1.0f, 0.0f, 0.0f);
        this.Shape3.func_78787_b(64, 64);
        this.Shape3.field_78809_i = true;
        this.setRotation(this.Shape3, 0.0f, 0.0f, 0.0f);
        (this.Shape4 = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, 0.0f, 0.0f, 1, 24, 1);
        this.Shape4.func_78793_a(-1.0f, 0.0f, 1.0f);
        this.Shape4.func_78787_b(64, 64);
        this.Shape4.field_78809_i = true;
        this.setRotation(this.Shape4, 0.0f, 0.0f, 0.0f);
        (this.Shape5 = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, 0.0f, 0.0f, 1, 24, 2);
        this.Shape5.func_78793_a(-1.0f, 0.0f, 2.6f);
        this.Shape5.func_78787_b(64, 64);
        this.Shape5.field_78809_i = true;
        this.setRotation(this.Shape5, 0.0f, 0.0f, 0.0f);
        (this.Shape6 = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, 0.0f, 0.0f, 1, 24, 2);
        this.Shape6.func_78793_a(-1.0f, -0.3333333f, 5.4f);
        this.Shape6.func_78787_b(64, 64);
        this.Shape6.field_78809_i = true;
        this.setRotation(this.Shape6, 0.0f, 0.0f, 0.0f);
        (this.Shape7 = new ModelRenderer((ModelBase)this, 0, 27)).func_78789_a(0.0f, 0.0f, 0.0f, 8, 1, 1);
        this.Shape7.func_78793_a(0.0f, 11.0f, 0.5f);
        ...
        this.Shape8.func_78793_a(0.0f, 20.0f, 0.5f);
        this.Shape8.func_78787_b(64, 64);
        this.Shape8.field_78809_i = true;
        this.setRotation(this.Shape8, 0.0f, 0.0f, 0.0f);
        (this.Shape9 = new ModelRenderer((ModelBase)this, 0, 27)).func_78789_a(0.0f, 0.0f, 0.0f, 8, 1, 1);
        this.Shape9.func_78793_a(0.0f, 3.0f, 0.5f);
        this.Shape9.func_78787_b(64, 64);
        this.Shape9.field_78809_i = true;
        this.setRotation(this.Shape9, 0.0f, 0.0f, 0.0f);
        (this.Shape10 = new ModelRenderer((ModelBase)this, 0, 27)).func_78789_a(0.0f, 3.0f, 0.0f, 8, 1, 1);
        this.Shape10.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Shape10.func_78787_b(64, 64);
        this.Shape10.field_78809_i = true;
        this.setRotation(this.Shape10, 0.0f, -1.561502f, 0.0f);
        (this.Shape11 = new ModelRenderer((ModelBase)this, 0, 27)).func_78789_a(0.0f, 11.0f, 0.0f, 8, 1, 1);
        this.Shape11.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Shape11.func_78787_b(64, 64);
        this.Shape11.field_78809_i = true;
        this.setRotation(this.Shape11, 0.0f, -1.561502f, 0.0f);
        (this.Shape12 = new ModelRenderer((ModelBase)this, 0, 27)).func_78789_a(0.0f, 20.0f, 0.0f, 8, 1, 1);
        this.Shape12.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Shape12.func_78787_b(64, 64);
        this.Shape12.field_78809_i = true;
        this.setRotation(this.Shape12, 0.0f, -1.561502f, 0.0f);
    }
    ...
    public void render(final float n) {
        ...
        this.Shape9.func_78785_a(n);
        this.Shape10.func_78785_a(n);
        this.Shape11.func_78785_a(n);
        this.Shape12.func_78785_a(n);
    }

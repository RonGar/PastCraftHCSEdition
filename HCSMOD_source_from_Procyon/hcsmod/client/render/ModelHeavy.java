...
public class ModelHeavy implements IVladruArmorModel
{
    ...
    public ModelHeavy() {
        this.model = new aozt("Heavy.obj", ModelJugger.class.getResourceAsStream("/assets/hcsmod/obj/Heavy.obj"));
    ...
    public void render(final ArmorRender.ModelPart modelPart) {
        ...
        switch (modelPart) {
            ...
            case LARM: {
                GL11.glTranslatef(-31.25f, 16.0f, 0.0f);

...
extends ModelPlane {
    public ModelTwoSeatBiplane() {
        ...
        this.bayModel[0].func_78790_a(-12.0f, -8.0f, -3.0f, 24, 16, 4, 0.0f);
        this.bayModel[0].setPosition(24.0f, 4.0f, 0.0f);
        this.bayModel[1].func_78790_a(-10.0f, -7.0f, -1.0f, 20, 6, 2, 0.0f);
        this.bayModel[1].setPosition(13.0f, 4.0f, 0.0f);
        this.bayModel[2].func_78790_a(-10.0f, -7.0f, -1.0f, 20, 6, 2, 0.0f);
        this.bayModel[2].setPosition(35.0f, 4.0f, 0.0f);
        this.bayModel[3].func_78790_a(-10.0f, -7.0f, -1.0f, 20, 6, 2, 0.0f);
        this.bayModel[3].setPosition(24.0f, 4.0f, -9.0f);
        this.bayModel[4].func_78790_a(-10.0f, -7.0f, -1.0f, 20, 6, 2, 0.0f);
        this.bayModel[4].setPosition(24.0f, 4.0f, 9.0f);

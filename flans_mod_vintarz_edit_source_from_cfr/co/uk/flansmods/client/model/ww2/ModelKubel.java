...
extends ModelVehicle {
    public ModelKubel() {
        ...
        this.bodyModel[9] = new ModelRendererTurbo(this, 90, 12, 128, 128);
        this.bodyModel[10] = new ModelRendererTurbo(this, 66, 49, 128, 128);
        this.bodyModel[0].func_78790_a(8.0f, -6.0f, -14.0f, 16, 12, 28, 0.0f);
        this.bodyModel[1].func_78790_a(-24.0f, 4.0f, -16.0f, 32, 2, 32, 0.0f);
        this.bodyModel[2].func_78790_a(8.0f, 0.0f, -16.0f, 16, 1, 2, 0.0f);
        this.bodyModel[3].func_78790_a(8.0f, 0.0f, 14.0f, 16, 1, 2, 0.0f);
        this.bodyModel[4].func_78790_a(-6.0f, -4.0f, -14.0f, 1, 8, 28, 0.0f);
        this.bodyModel[5].func_78790_a(-24.0f, -6.0f, -14.0f, 4, 10, 28, 0.0f);
        this.bodyModel[6].func_78790_a(-24.0f, -6.0f, -16.0f, 32, 10, 2, 0.0f);
        this.bodyModel[7].func_78790_a(-24.0f, -6.0f, -16.0f, 32, 10, 2, 0.0f);
        this.bodyModel[7].doMirror(false, false, true);
        this.bodyModel[8].func_78790_a(8.0f, -14.0f, -16.0f, 1, 8, 32, 0.0f);
        this.bodyModel[9].func_78790_a(12.0f, -8.0f, -4.0f, 8, 2, 8, 0.0f);
        this.bodyModel[10].func_78790_a(-6.0f, -18.0f, -0.5f, 1, 14, 1, 0.0f);
        this.leftBackWheelModel = new ModelRendererTurbo[1];
        this.leftBackWheelModel[0] = new ModelRendererTurbo(this, 90, 22, 128, 128);
        this.leftBackWheelModel[0].func_78790_a(-20.0f, 6.0f, 13.0f, 8, 4, 2, 0.0f);
        this.rightBackWheelModel = new ModelRendererTurbo[1];
        this.rightBackWheelModel[0] = new ModelRendererTurbo(this, 90, 22, 128, 128);
        this.rightBackWheelModel[0].func_78790_a(-20.0f, 6.0f, -15.0f, 8, 4, 2, 0.0f);
        ...
        this.leftFrontWheelModel[0].func_78793_a(16.0f, 6.0f, 15.0f);
        ...
        this.rightFrontWheelModel[0].func_78793_a(16.0f, 6.0f, -15.0f);
        ModelRendererTurbo[][] arrmodelRendererTurbo = new ModelRendererTurbo[][]{new ModelRendererTurbo[0], new ModelRendererTurbo[4], null};
        arrmodelRendererTurbo[1][0] = new ModelRendererTurbo(this, 66, 77, 128, 128);
        arrmodelRendererTurbo[1][1] = new ModelRendererTurbo(this, 66, 72, 128, 128);
        arrmodelRendererTurbo[1][2] = new ModelRendererTurbo(this, 74, 75, 128, 128);
        arrmodelRendererTurbo[1][3] = new ModelRendererTurbo(this, 84, 68, 128, 128);
        arrmodelRendererTurbo[1][0].addBox(-8.0f, -1.0f, -1.0f, 16, 2, 2);
        arrmodelRendererTurbo[1][1].addBox(-4.0f, 1.0f, -1.0f, 2, 3, 2);
        arrmodelRendererTurbo[1][2].addBox(8.0f, -0.5f, -0.5f, 4, 1, 1);

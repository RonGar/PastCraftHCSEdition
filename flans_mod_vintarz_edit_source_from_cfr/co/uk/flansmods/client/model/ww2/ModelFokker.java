...
extends ModelPlane {
    public ModelFokker() {
        ...
        this.bodyModel[5] = new ModelRendererTurbo(this, 0, 8, 128, 128);
        ...
        this.bodyModel[1].setPosition(-11.0f, 0.0f, 0.0f);
        this.bodyModel[2].func_78790_a(-10.0f, -7.0f, -1.0f, 20, 6, 2, 0.0f);
        this.bodyModel[2].setPosition(11.0f, 0.0f, 0.0f);
        this.bodyModel[3].func_78790_a(-10.0f, -7.0f, -1.0f, 20, 6, 2, 0.0f);
        this.bodyModel[3].setPosition(0.0f, 0.0f, -9.0f);
        this.bodyModel[4].func_78790_a(-10.0f, -7.0f, -1.0f, 20, 6, 2, 0.0f);
        this.bodyModel[4].setPosition(0.0f, 0.0f, 9.0f);
        ...
        this.bodyModel[5].func_78790_a(-12.0f, -8.0f, -3.0f, 24, 16, 4, 0.0f);
        ...
        this.rightWingModel[1] = new ModelRendererTurbo(this, 64, 0, 128, 128);
        this.rightWingModel[2] = new ModelRendererTurbo(this, 64, 0, 128, 128);
        this.rightWingModel[3] = new ModelRendererTurbo(this, 64, 0, 128, 128);
        this.rightWingModel[4] = new ModelRendererTurbo(this, 56, 15, 128, 128);
        ...
        this.leftWingModel[1] = new ModelRendererTurbo(this, 64, 0, 128, 128);
        this.leftWingModel[2] = new ModelRendererTurbo(this, 64, 0, 128, 128);
        this.leftWingModel[3] = new ModelRendererTurbo(this, 64, 0, 128, 128);
        this.leftWingModel[4] = new ModelRendererTurbo(this, 56, 15, 128, 128);
        ...
        this.tailModel[0] = new ModelRendererTurbo(this, 118, 43, 128, 128);

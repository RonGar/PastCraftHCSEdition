...
extends ModelPlane {
    public ModelSpitfire() {
        ...
        this.tailModel[0] = new ModelRendererTurbo(this, 0, 0, 256, 128);
        ...
        this.leftWingModel[2] = new ModelRendererTurbo(this, 192, 25, 256, 128);
        this.leftWingModel[0].func_78790_a(-25.0f, -2.0f, 0.0f, 32, 2, 78, 0.0f);
        this.leftWingModel[0].setPosition(0.0f, 5.0f, 0.0f);
        this.leftWingModel[1].addTrapezoid(-25.0f, 3.0f, 78.0f, 32, 2, 10, 0.0f, -1.0f, 1);
        this.leftWingModel[2].func_78790_a(-37.0f, 3.0f, 43.0f, 12, 2, 2, 0.0f);
        ...
        this.rightWingModel[2] = new ModelRendererTurbo(this, 192, 25, 256, 128);
        this.rightWingModel[0].addBox(-32.0f, -2.0f, -78.0f, 32, 2, 78);
        this.rightWingModel[0].field_78796_g = 3.1415927f;
        this.rightWingModel[0].setPosition(-25.0f, 5.0f, -78.0f);
        this.rightWingModel[1].addTrapezoid(-32.0f, 3.0f, -88.0f, 32, 2, 10, 0.0f, -1.0f, 1);
        this.rightWingModel[1].field_78796_g = 3.1415927f;
        this.rightWingModel[1].setPosition(-25.0f, 0.0f, -166.0f);
        this.rightWingModel[2].func_78790_a(-37.0f, 3.0f, -45.0f, 12, 2, 2, 0.0f);
